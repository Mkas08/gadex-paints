       ...
       <div className="max-w-7xl mx-auto px-6">
          ...
          >
                   ...
                   <div className="w-full md:w-1/2 md:p-10">
                      ...
                      >
                         ...
                         <div className="flex items-center justify-between border-t border-gray-200 pt-6">
                             <button onClick={() => window.open('https://wa.me/2348025852790', '_blank')} className="flex items-center gap-2 text-gadex-black hover:text-gadex-gold transition-colors uppercase text-sm font-bold tracking-widest">
           ...
           <motion.div 
             ...
             className="mt-32"
           >
              <h2 className="text-4xl font-serif mb-12 text-center">Visual Inspiration</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                 {[
                   '/assets/IMG-20260511-WA0003.jpg',
                   '/assets/IMG-20260511-WA0005.jpg',
                   '/assets/IMG-20260511-WA0006.jpg',
                   '/assets/IMG-20260511-WA0007.jpg',
                   '/assets/IMG-20260511-WA0008.jpg',
                   '/assets/IMG-20260511-WA0009.jpg',
                   '/assets/IMG-20260511-WA0010.jpg',
                   '/assets/IMG-20260511-WA0011.jpg',
                   '/assets/IMG-20260511-WA0015.jpg',
                   '/assets/IMG-20260511-WA0016.jpg',
                 ].map((img, i) => (
                   <motion.div 
                     key={i}
                     whileHover={{ y: -10 }}
                     className="aspect-square bg-gray-100 overflow-hidden rounded-sm"
                   >
                     <img src={img} alt={`Gadex Space ${i}`} className="w-full h-full object-cover" />
                   </motion.div>
                 ))}
              </div>
           </motion.div>
